...
async function main() {
  ...
  Example_3:
    ...
    DEVELOPER: { "step": "OBSERVE", "content": "The website 'https://www.piyushgarg.dev' has been cloned successfully, with a limit of 100 pages to avoid overloading the server." }
